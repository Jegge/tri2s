/*
 *	miggl.h - Mignonette Game Library, v0.93 - definitions
 *
 ...
 *
 *	- may 18, 2010 - mitch
 *		add define for 8MHz internal oscillator or 16MHz external resonator.
 *      move define for F_CPU to miggl.h from uart.h .
 *
 *	- apr 12, 2009 - rolf
...
/* make one of these 1 and the other 0 */
/* this chooses 8MHz internal oscillator or 16MHz external resonator */
#define EIGHT_MHZ 1
#define SIXTEEN_MHZ	0

/* define F_CPU according to above */
